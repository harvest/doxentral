...
<script type="text/javascript" src="<?=base_url()?>swfupload/swfupload.js"></script>
<script type="text/javascript" src="<?=base_url()?>swfupload/swfupload.queue.js"></script>
<script type="text/javascript" src="<?=base_url()?>fileprogress.js"></script>
<script type="text/javascript" src="<?=base_url()?>handlers.js"></script>
...
SWFUpload.onload = function () {
	var settings = {
		...
		flash9_url : "<?=base_url()?>swfupload/swfupload_fp9.swf",
