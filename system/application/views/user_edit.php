...
<form action="#" method="post" name="frmUserProfile" id="frmUserProfile">
  ...
  <p>
    ...
    <?php
    	...
    	$options_user_type = array('1' => 'Administrator',
    								'2' => 'User');
    	echo form_dropdown('user_type', $options_user_type, $user_data['user_type'], 'id="user_type"');
    ?>
  </p>
...
$(document).ready(function(){
	$('#update_user').click(function(){
	    ...
	    $.ajax({
	    	   type: "POST",
	    	   url: '<?= site_url("profile/update").'/'.$user_data['user_id'] ?>',
