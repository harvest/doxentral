...
function validateForm() {
	...
	var txtFirstName = document.getElementById("file_title");
	var txtEducation = document.getElementById("file_desc");
...
function uploadSuccess(file, serverData) {
	try {
		...
		if (serverData == "" || parseInt(arrData[0]) <= 0) {
			this.customSettings.upload_successful = false;
		} else {
			this.customSettings.upload_successful = true;
			document.getElementById("file_id").value = arrData[0];
		}
